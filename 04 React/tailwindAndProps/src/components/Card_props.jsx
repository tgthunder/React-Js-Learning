...
// props are parameters that are passed to components during rendering
// props provide resuability means you can reuse the component strucutre by changing only data 

function Card({username ,buttonText="Click Here" }) { // this is direct 
    // destructuring of props object
    // you can write default value for prop 
  ...
  return (
    ...
    <div className="bg-white shadow-md border border-gray-200 rounded-lg max-w-sm dark:bg-gray-800 dark:border-gray-700">
        ...
        <div class="p-5">
            <a href="#">
                <h5 className="text-gray-900 font-bold text-2xl tracking-tight mb-2 dark:text-white"> Sudarshan Furniture Works</h5>
            </a>
